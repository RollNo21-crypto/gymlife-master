...
(function ($) {
    ...
    /*------------------
        Schedule Mobile Carousel
    --------------------*/
    $(".schedule-mobile-carousel").owlCarousel({
        loop: true,
        margin: 20,
        nav: true,
        items: 1,
    ...
    $('.table-controls ul li').on('click', function () {
        ...
        if (tsfilter == 'all') {
            ...
            $('.schedule-grid .schedule-card').fadeIn();
        } else {
            $('.class-timetable').addClass('filtering');
            $('.schedule-grid .schedule-card').hide();
            $('.schedule-grid .schedule-card[data-tsmeta="' + tsfilter + '"]').fadeIn();
        }
